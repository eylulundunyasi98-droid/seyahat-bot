...
const CITY_CODES: Record<string, string> = {
  ...
  'san paolo': 'SAO',
  // Ülkeler -> başkent havalimanı (kullanıcı ülke yazarsa)
  'turkiye': 'IST', 'turkey': 'IST',
  'almanya': 'BER', 'germany': 'BER', 'deutschland': 'BER',
  'fransa': 'PAR', 'france': 'PAR',
  'ingiltere': 'LON', 'england': 'LON', 'united kingdom': 'LON', 'uk': 'LON',
  'italya': 'ROM', 'italy': 'ROM',
  'ispanya': 'MAD', 'spain': 'MAD',
  'hollanda': 'AMS', 'netherlands': 'AMS',
  'belcika': 'BRU', 'belgium': 'BRU',
  'isvicre': 'ZRH', 'switzerland': 'ZRH',
  'avusturya': 'VIE', 'austria': 'VIE',
  'polonya': 'WAW', 'poland': 'WAW',
  'portekiz': 'LIS', 'portugal': 'LIS',
  'yunanistan': 'ATH', 'greece': 'ATH',
  'isvec': 'STO', 'sweden': 'STO',
  'norvec': 'OSL', 'norway': 'OSL',
  'danimarka': 'CPH', 'denmark': 'CPH',
  'finlandiya': 'HEL', 'finland': 'HEL',
  'rusya': 'MOW', 'russia': 'MOW',
  'cin': 'BJS', 'china': 'BJS',
  'japonya': 'TYO', 'japan': 'TYO',
  'hindistan': 'DEL', 'india': 'DEL',
  'amerika': 'NYC', 'usa': 'NYC', 'united states': 'NYC',
  'kanada': 'YTO', 'canada': 'YTO',
  'brezilya': 'SAO', 'brazil': 'SAO',
  'avustralya': 'SYD', 'australia': 'SYD',
  'meksika': 'MEX', 'mexico': 'MEX',
  'misir': 'CAI', 'egypt': 'CAI',
  'fas': 'CAS', 'morocco': 'CAS',
